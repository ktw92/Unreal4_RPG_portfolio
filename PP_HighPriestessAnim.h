...
#include "PP_HighPriestessAnim.generated.h"

/**
 * 
 */
UCLASS()
class ELFPALADINTEMPLATE_API UPP_HighPriestessAnim : public UAnimInstance
{
	GENERATED_BODY()
public:
	UPP_HighPriestessAnim();
